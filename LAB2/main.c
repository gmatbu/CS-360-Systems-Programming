...
static char* dirname;// a/b from pathname a/b/c
static char* basename;// c from pathname a/b/c
...
int main()
{
	...
	while(1)
	{
		int (*fptr)(char*, char*);// Pointer to function for command
